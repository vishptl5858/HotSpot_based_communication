 ...
 */
public class WificallBroadcast extends BroadcastReceiver {

    private WifiP2pManager manager;
    private Channel channel;
    private CallDeviceList activity;
     ...
     */
    public WificallBroadcast(WifiP2pManager manager, Channel channel,
                                       CallDeviceList activity) {
        super();
